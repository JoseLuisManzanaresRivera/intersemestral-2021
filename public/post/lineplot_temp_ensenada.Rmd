...
Estimaremos la trayectoria de la temperatura  máxima y minima y el intervalo de confianza para la variable temperatura a lo largo del periodo de interés. 
...
Ejemplo 2: Estimación de  la trayectoria de precipitación y el rango intercuartil para la variable de interés.
