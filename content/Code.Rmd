...
#Nota: Temperatura Plot
[Datos:](http://smn.cna.gob.mx/es/climatologia/informacion-climatologica)
[Alternativa datos](http://atlasclimatico.unam.mx/RRDM/)
...
ggsave("DGO_bxplot_Tmin.tiff",width = 21, height = 16, units = "cm",dpi=300)
