...
El valor que se localiza en la mitad de los datos cuando los datos son organizados en orden (ej. ascendente).

En contraste con la media, **la mediana** no es afectada por los puntos extremos (**outliers**)


Una medida que es representativa  de la tendencia central cuando los datos tienen sesgo, ej. cuando la media y la mediana no son iguales. Es preferible a la media cuando los datos no tienen una distribución simétrica. 
