...
Este tipo de variables no tiene un comportamiento aleatorio, pero sus observaciones son dependientes de los valores que tome a variable en momentos previos (lags.). 
...
¿Qué podemos decir de la variación en el nivel de ingreso entre los países de la muestra entre el año **1952** y **2007**. ¿Cuál es la tasa de crecimiento?


**Ejercicio** clase, estime la media aritmética y geométrica para las variables población y esperanza de vida por continente.
...
Para estimación en python See **ipynb**
...
Una de las medidas más sencillas para medir la dispersión en la distribución de los datos es mediante la diferencia entre el dato maximo u el mínimo, este indicador se denomina **Rango **

En la estimación del rango se debe tener cuidado con la presencia de outliers (datos extremos atípicos).


Es común estimar el **rango intercuartil** que marca la distancia entre el dato en el percentil 25 y el 75.. En la práctica, el percentil 25 se denomina  **Q1**  o primer cuartil y el percentil 75 se denomina cuartil 3 o **Q3**. 
...
Veramos con  detalle este concepto en la siguiente sección cunado abordemos la estimación de los percentiles.
...
Determine los cuantiles Q1, Q2, Q3, Q4 para la variable esperanza de vida (lifexp) expresada en años para los paises de cada continente.

¿Qué continente tiene la mayor esperanza de vida (ej. cuál tiene el Q4 mayor).

¿Cuál es la diferencia  entre el **Q1** de **Africa** y **Q1** del continente con menor esperanza de vida? 
...
Europa<-cuantiles%>%filter(continent=="Europa")
