...
Meida poblaciónal con la letra griega:
$$\mu$$

Desde a perspectiva de probabilidad, la podemos definir en términos del valor esperado como  $$E[X]=\sum_{i} x_ip_i=1$$

+ Note que el valor esperado es una función de la distribución de probabilidad exprezada como *f(x)* en nuestra población.

+ La media muestral converge al **valor esperado** **E[X]** a medida que el tamaño de muestra es mayor. 

Donde  **$x_{i}$** representa todos los valores posibles que laa variable x puede tomar.
