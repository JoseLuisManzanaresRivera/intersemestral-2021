...
**Por ejemplo**, si mi base de datos se nombra  **x**  y dentro de este  **data frame** tengo una variable denominada **ingreso** que me interesa conocer la desviación estandar, entonces lo puedo estimar con la siguiente especificación `sd(x$ingreso)`. 
