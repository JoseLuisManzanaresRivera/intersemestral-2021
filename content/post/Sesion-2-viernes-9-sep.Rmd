...
**Importante**: La **validéz** de las estimaciones para diferentes distribuciones de datos depende de la simetría de la distribución de los datos, esto es, depende de que la distribución de los datos se comporte conforme al criterio de  **normalidad**. 
...
**Definición del concepto de GRADOS DE LIBERTAD**
...
Con los datos  disponibles sobre precipitaciones registrados en la estación meteorológica  en Tijuana, determine: 
...
Revise la página 42  sección: "aplica tus conocimientos", del libro de texto [](Estadística aplicada básica, 2a ed.) y realiza los ejercicios.  **Ej 1.31, 1.32, 1.33**
...
Una **caso particular de distribución esta dado cuando observamos simetría** (ej. media, mediana son igueales). 
...
¿Por que tanto enfasis en las distribciones normales? 

+ Por que describen una gran cantidad de situaciones empíricas de naturaleza aleatoria.

+ Los procesos de **inferencia estadística**   permiten resultados confiables (robusos) cuando se aplican a distribuciones simétricas. Dependen de esta condición.  
...
[Libro de texto](Subir libro de texto Estadística aplicada básica ubicado en docencia books) sección 1.44, páginas 64-79.