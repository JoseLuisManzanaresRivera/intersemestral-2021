...
Para estimar el primer parámetro, consideramos la raíz cuadrada del numero de obsrevaciones en el conjunto de datos.
...
### Load data. contiene registros de nacimientos con sindrome de dificultadad respiratoria. MX, Variables de interes, peso y tipo de parto  ej cesarea o eutócico.
