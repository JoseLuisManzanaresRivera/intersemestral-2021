...
Por **ejemplo**, considerando los datos del ejercicio anterior, vemos que la media $\mu=110$, $\sigma=25$, por lo que el coeficiente estandarizado de una persona cuyo IQ= 105, será $z=\frac{105-110}{25}=-.20$.  

Y se interpreta como la distancia en términos de desviaciones estándar respecto a la media. Así el dato IQ de 105 se ubica a una distancia de un quinto desviaciones estandar menor a la media. 
