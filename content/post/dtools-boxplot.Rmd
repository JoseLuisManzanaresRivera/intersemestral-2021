...
ex <-getURLContent("https://github.com/JoseLuisManzanaresRivera/intersemestral-2021/blob/main/content/post/TASA17.rds")



asosdate <- getURL("https://github.com/JoseLuisManzanaresRivera/intersemestral-2021/blob/main/content/post/TASA17.rds?raw=true")


 ("https://github.com/JoseLuisManzanaresRivera/intersemestral-2021/raw/main/content/post/TASA17.rds")




casosdate <- getURL("https://raw.githubusercontent.com/carranco-sga/Mexico-COVID-19/master/Mexico_COVID19_CTD.csv",ssl.verifypeer=TRUE)



dgo_temp<-readRDS("dgo_temps.rds")

## Damos un vistazo a los datos para combrabar que las variables estan estan en el formato apropiado para su análisis.
