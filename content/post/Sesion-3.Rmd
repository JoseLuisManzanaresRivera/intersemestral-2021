...
### Objetico: Aprender a realizar análisis y representación de datos en formato series de tiempo usando librerias javscrip. 
...
dygraph(son_ac1, group= "d", main = "Sonora State data vs. Federal Government Offical OD")%>% 
dyRangeSelector()%>%
...
dygraph(son_ac2,  group= "d", main = "Gap size: cases, %")%>% 
dyRangeSelector()%>%
dyHighlight(highlightCircleSize = 3, 
highlightSeriesBackgroundAlpha = 0.2,
hideOnMouseOut = FALSE)%>%
...
## El argumento 3  indica la cantidad de colores que corresponde con la cantidad de series (lineas)   a representar. 
