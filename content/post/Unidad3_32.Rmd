...
Para investigar la calidad del agua, a fines de julio de 2021, el Departamento de Salud de la comisi[on fronteriza de Tijuana recolectó muestras de agua de 12 playas entre Rosarito y  San Antonio del Mar en el Municipio de Tijuana.
...
# (b) Simretría.   Muestra asimétrica !!1!!
stem(t1$NCF.100ml)

#(c) Normalidad:  COn Shapiro.

shapiro.test(t1$NCF.100ml) # => p-value = 0.03 !!!!  Al nivel de significancia del 0.05 rechazamos H0. Normalidad. Concluimos que estos datos no provienen de una distribución normal.
...
# No se aprecian valores atipicos. no se tiene asímetria aparente. 
