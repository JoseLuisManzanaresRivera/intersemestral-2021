...
+ $$\integral_{-\infty}^{\infty}     p_{(x)}dx=1$$
![](\img\PDF_probability)

La integral sobre p(x) en el rango [a,b] representa la probabilidad de encontrar el valor **x** en ese **intervalo**.  El area bajo la curva, determina el valor de esa probabilidad en el intervalo particular.

Una nota sobre la apliación de la CDF es en la obtención de los **Percentiles** 

Permiten determinar el valor por debajo del cual, ocurre un determinado porcentaje de los datos.
