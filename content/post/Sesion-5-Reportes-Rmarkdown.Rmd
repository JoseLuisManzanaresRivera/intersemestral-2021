...
```{r}
library(foreign)
a<-read.csv("C:/Cartografía_básica/Aprovechamientos/Mexico/CHIHUAHUA.csv")
b<-read.dbf("C:/Users/LENOVO/Desktop/DESK/I/2019/CONVID/gis/Acuiferos.dbf")
C:\Users\LENOVO\Desktop\DESK\I\2019\CONVID\gis
```
