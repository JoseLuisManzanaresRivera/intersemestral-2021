...
Enteder probabilidad básica y distribuciones probabilisticas. 


> Experimentos aleatorios: Los resultados de eventos cuyo resultado es incierto por ejemplo: 

+ Lanzar una moneda puede tener el resultado de Sol **S**  simbolizado como 0 y águila **A**, simbolizado como 1. Lo que integral el conjunto {S,A}, {0,1}.

+ Lanzamiento de un dado con el resultado unio de lo snúmeros en el conjunto  {1,2,3,4,5,6}.
