...
date: 2022-10-05T22:09:14-05:00
...
[Libro de texto para consulta para el tema de la sesión de hoy.]()
...
+ Lanzamiento de un dado con el resultado uno de lo snúmeros en el conjunto  {1,2,3,4,5,6}.
...
En este caso laprobabilidad de que caiga águila será $$P[A]=\frac{1}{2}=.50$$

Determine la probabilidad de que al lanzar dos monedas caiga al menos un sol.


Primero determinamos primero los elementos que componen el evento muestral.

"Al menos un sol".

A={sa, as, ss}. Ahora nos preguntamos, cuentos resultados posibles hay.  Si son dos lanzamientos hay 4 resultados posibles. Y cuandtos elementos componen el evento muestal?  Son tres posibles elementos los que integran el evento muestral que cumple la proposición. **"Al menos un sol".**
...
De manera complementaria hay una probabilidad del $25\%$ de obtener de no obtener un sol en los dos lanzamientos.
