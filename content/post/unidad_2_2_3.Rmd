...
Vemos que la probabiliad de los elementos comunes $P(A \cap B)=\frac{2}{6}=\frac{1}{3}$
...
Supónga que lanza una moneda dos veces y hace un recuento de los "soles". Los sucesos de interés son:
...
Los sucesos **A** y **B** no son mutuamente excluyentes. 

Ocurren simultáneamente siempre que
...
¿Cuál es la probabilidad de A y B  $P(A \cap B)$?  aplicando la regla indicada tenemos: $P(A\cap B)=P(A)P(B)=\frac{1}{2}(\frac{1}{2})=\frac{1}{4}$
